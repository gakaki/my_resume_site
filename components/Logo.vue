    ...
    <div class="top_bar" >
      ...
      <div class="wrap_top_bar">
        <ul class="nav">
          ...
          <li>
            <a class="btn btn-pdf" href="resume.pdf" target="_blank" download="潘峰个人简历.doc">
              Word
            </a>
          </li>

          <li>
            <a class="btn btn-pdf" href="resume.pdf" target="_blank" download="潘峰个人简历.pdf">
              PDF
            </a>
          </li>
      ...
      return {
        ...
        job_history: [
          ...
          },
          {
            ...
            time_end: '2012.02',
            job_desc: [
              '研发和维护 Shopex B2B B2C 产品,开发和Bug修复.新版本的ECOS的压力测试（libmemcached，tsung，多台Archlinux，mysql5.55beta）。使用Python编写多线程的B2B平台与淘宝API的数据同步，用到了MySQL Q4M 消息队列 . 维护网店的B2C的功能 , 当时使用的技术架构 php 5.2 + mysql + q4m + sphinx +tokey tryant + mootools',
